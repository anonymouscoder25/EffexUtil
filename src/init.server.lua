...
return function()
    for _,comp in ipairs(playerGui:GetDescendants()) do
        if comp:IsA("GuiObject") then
            ...
            if comp.Parent and not comp.Parent:FindFirstChildWhichIsA("UIGridLayout") then
            ...
            elseif comp:IsA("TextButton") then

            elseif comp.Parent and comp.Parent:IsA("ScreenGui") then
